...
goog.string.compareElements_(m[2],n[2])}while(0==c)}return c};goog.string.compareElements_=function(a,b){return a<b?-1:a>b?1:0};goog.string.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c)>>>0;return b};goog.string.uniqueStringCounter_=2147483648*Math.random()|0;goog.string.createUniqueString=function(){return"goog_"+goog.string.uniqueStringCounter_++};goog.string.toNumber=function(a){var b=Number(a);return 0==b&&goog.string.isEmptyOrWhitespace(a)?NaN:b};
...
DOMCHARACTERDATAMODIFIED:"DOMCharacterDataModified",BEFOREPRINT:"beforeprint",AFTERPRINT:"afterprint"};goog.reflect={};goog.reflect.object=function(a,b){return b};goog.reflect.sinkValue=function(a){goog.reflect.sinkValue[" "](a);return a};goog.reflect.sinkValue[" "]=goog.nullFunction;goog.reflect.canAccessProperty=function(a,b){try{return goog.reflect.sinkValue(a[b]),!0}catch(c){}return!1};goog.reflect.cache=function(a,b,c,d){d=d?d(b):b;return d in a?a[d]:a[d]=c(b)};goog.events.BrowserEvent=function(a,b){goog.events.Event.call(this,a?a.type:"");this.relatedTarget=this.currentTarget=this.target=null;this.charCode=this.keyCode=this.button=this.screenY=this.screenX=this.clientY=this.clientX=this.offsetY=this.offsetX=0;this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.state=null;this.platformModifierKey=!1;this.event_=null;a&&this.init(a,b)};goog.inherits(goog.events.BrowserEvent,goog.events.Event);
...
goog.html.legacyconversions.reportCallback_=goog.nullFunction;goog.html.legacyconversions.setReportCallback=function(a){goog.html.legacyconversions.reportCallback_=a};goog.math={};goog.math.randomInt=function(a){return Math.floor(Math.random()*a)};goog.math.uniformRandom=function(a,b){return a+Math.random()*(b-a)};goog.math.clamp=function(a,b,c){return Math.min(Math.max(a,b),c)};goog.math.modulo=function(a,b){var c=a%b;return 0>c*b?c+b:c};goog.math.lerp=function(a,b,c){return a+c*(b-a)};goog.math.nearlyEquals=function(a,b,c){return Math.abs(a-b)<=(c||1E-6)};goog.math.standardAngle=function(a){return goog.math.modulo(a,360)};
...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};var P={control:{}};P.control.catastroSearchButtonControl={};
M.control.catastroSearchButtonControl=function(a){M.utils.isUndefined(M.impl.control.catastroSearchButtonControl)&&M.exception("La implementaci\u00f3n usada no puede crear controles catastroSearchButtonControl");a?(this.options=a.options||{},this.config_=a.config||{}):M.exception("CatastroSearchButtonControl: configuraci\u00f3n no v\u00e1lida");if(M.utils.isUndefined(this.options.name)||M.utils.isNullOrEmpty(this.options.name))this.options.name=M.control.catastroSearchButtonControl.NAME;a=new M.impl.control.catastroSearchButtonControl;
this.inputParcela=this.inputPoligono=this.selectMunicipios=this.selectProvincias=this.inputRC_=this.facadeMap_=null;this.ConsultaMunicipioCodigos_=this.config_.CMC_url;this.DNPRC_url_=this.config_.DNPRC_url;this.CPMRC_url_=this.config_.CPMRC_url;this.DNPPP_url_=this.config_.DNPPP_url;this.RCCOOR_url_=this.config_.RCCOOR_url;this.searchingParamsResult_=this.searchingRCResult_=this.resultsScrollContainer_=this.resultsParamsContainer_=this.resultsRCContainer_=null;this.searchTime_=0;this.rcResults_=
[];this.paramsResults_=[];this.scrollIsUp_=!0;this.draggablePanel=null;this.panelMinimized=!1;this.layer_=new M.layer.GeoJSON({name:"Localizador Catastral",crs:"25830"});this.element_=null;M.Control.call(this,a,M.control.catastroSearchButtonControl.NAME)};goog.inherits(M.control.catastroSearchButtonControl,M.Control);
M.control.catastroSearchButtonControl.prototype.createView=function(a){var b=this;this.facadeMap_=a;this.facadeMap_.addLayers(this.layer_);this.layer_.displayInLayerSwitcher=!1;return new Promise(function(a,d){M.template.compile(M.control.catastroSearchButtonControl.TEMPLATE,{}).then(function(d){b.setStyle(d,b.options);b.element_=d;b.createCatastroPanel();b.addEvents(b.element_);b.togglePanel();a(d)})})};
M.control.catastroSearchButtonControl.prototype.addEvents=function(a){this.element_=a;this.resultsRCContainer_=this.element_.querySelector("div#m-searchRC-results");this.searchingRCResult_=this.element_.querySelector("div#m-searchRC-results > div#m-searching-result-searchRC");this.resultsParamsContainer_=this.element_.querySelector("div#m-searchParams-results");this.searchingParamsResult_=this.element_.querySelector("div#m-searchParams-results > div#m-searching-result-searchParams")};
M.control.catastroSearchButtonControl.prototype.createCatastroPanel=function(){var a=this.element_.querySelector("div#m-searchRC-container"),b=this.element_.querySelector("div#m-searchParams-container"),c=this.element_.querySelector("div#m-searchRC-results"),d=this.element_.querySelector("div#m-searchParams-results"),e=this.element_.querySelector("ul#m-tabs-catastrosearch > li:nth-child(1) > a"),f=this.element_.querySelector("ul#m-tabs-catastrosearch > li:nth-child(2) > a");goog.events.listen(e,goog.events.EventType.CLICK,
function(){goog.dom.classlist.contains(e,"activated")||(goog.dom.classlist.add(e,"activated"),goog.dom.classlist.remove(f,"activated"),goog.dom.classlist.add(a,"show"),goog.dom.classlist.add(c,"show"),goog.dom.classlist.remove(d,"show"),goog.dom.classlist.remove(b,"show"))},!1,this);goog.events.listen(f,goog.events.EventType.CLICK,function(){goog.dom.classlist.contains(f,"activated")||(goog.dom.classlist.add(f,"activated"),goog.dom.classlist.remove(e,"activated"),goog.dom.classlist.remove(a,"show"),
goog.dom.classlist.remove(c,"show"),goog.dom.classlist.add(d,"show"),goog.dom.classlist.add(b,"show"))},!1,this);this.inputRC_=this.element_.getElementsByTagName("input")["m-searchRC-input"];goog.events.listen(this.inputRC_,goog.events.EventType.KEYUP,this.onRCSearch,!1,this);var g=this.element_.getElementsByTagName("button")["m-catastrosearch-button"];goog.events.listen(g,goog.events.EventType.CLICK,this.activeSearch,!1,this);g=this.element_.getElementsByTagName("button")["m-catastrogetinfo-button"];
goog.events.listen(g,goog.events.EventType.CLICK,this.activeInfo,!1,this);g=this.element_.getElementsByTagName("button")["m-catastroclear-button"];goog.events.listen(g,goog.events.EventType.CLICK,this.clearResults,!1,this);this.selectProvincias=this.element_.getElementsByTagName("select")["m-searchParamsProvincia-select"];goog.events.listen(this.selectProvincias,goog.events.EventType.CHANGE,this.onProvinciaSelect,!1,this);this.selectMunicipios=this.element_.getElementsByTagName("select")["m-searchParamsMunicipio-select"];
this.inputPoligono=this.element_.getElementsByTagName("input")["m-searchParamsPoligono-input"];this.inputParcela=this.element_.getElementsByTagName("input")["m-searchParamsParcela-input"];g=this.element_.getElementsByTagName("button")["m-searchRC-button"];goog.events.listen(g,goog.events.EventType.CLICK,this.onRCSearch,!1,this);g=this.element_.getElementsByTagName("button")["m-searchParams-button"];goog.events.listen(g,goog.events.EventType.CLICK,this.onParamsSearch,!1,this);g=this.element_.getElementsByTagName("button")["m-clearRC-button"];
goog.events.listen(g,goog.events.EventType.CLICK,this.clearResults,!1,this);g=this.element_.getElementsByTagName("button")["m-clearParams-button"];goog.events.listen(g,goog.events.EventType.CLICK,this.clearResults,!1,this)};
M.control.catastroSearchButtonControl.prototype.setStyle=function(a,b){M.utils.isUndefined(b.tooltip)||M.utils.isNullOrEmpty(b.tooltip)||a.querySelector("button").setAttribute("title",b.tooltip);M.utils.isUndefined(b.icon)||M.utils.isNullOrEmpty(b.icon)||a.querySelector("button").setAttribute("class",b.icon);M.utils.isUndefined(b.order)||M.utils.isNullOrEmpty(b.order)||(a.querySelector("button").parentNode.style.order=b.order)};
M.control.catastroSearchButtonControl.prototype.activeSearch=function(){this.deactivate();this.togglePanel()};M.control.catastroSearchButtonControl.prototype.activeInfo=function(){!1===this.panelMinimized&&this.togglePanel();this.activate()};
M.control.catastroSearchButtonControl.prototype.addClearEvents=function(a){this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(a,"shown")},this);var b=a.getElementsByTagName("button")["m-clearRC-button"];goog.events.listen(b,goog.events.EventType.CLICK,this.clearResults,!1,this);b=a.getElementsByTagName("button")["m-clearParams-button"];goog.events.listen(b,goog.events.EventType.CLICK,this.clearResults,!1,this);b=a.getElementsByTagName("a")["dialog-close-catastro"];goog.events.listen(b,goog.events.EventType.CLICK,
this.clearResults,!1,this)};goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"addClearEvents",M.control.catastroSearchButtonControl.prototype.addClearEvents);M.control.catastroSearchButtonControl.prototype.clearResults=function(){this.clearClick_()};M.control.catastroSearchButtonControl.prototype.equals=function(a){var b=!1;a instanceof M.control.catastroSearchButtonControl&&(b=this.name===a.name);return b};M.control.catastroSearchButtonControl.NAME="catastroSearchButton";
M.control.catastroSearchButtonControl.prototype.activate=function(){if(this.activated)this.deactivate();else{var a=!1;this.facadeMap_.getControls().some(function(b){if(!0===b.activated&&!(b instanceof M.control.catastroSearchButtonControl))return M.dialog.info("Desactive el control "+b.name+" antes de activar \u00e9ste"),a=!0});!1===a?(this.facadeMap_.on(M.evt.CLICK,this.buildUrl_,this),this.activated=!0,goog.dom.classlist.add(this.element_.getElementsByTagName("button")["m-catastrogetinfo-button"],
"activated")):this.activated=!1}};M.control.catastroSearchButtonControl.prototype.buildUrl_=function(a){var b=this,c=this.facadeMap_.getProjection().code;M.remote.get(this.RCCOOR_url_,{SRS:c,Coordenada_X:a.coord[0],Coordenada_Y:a.coord[1]}).then(function(c){b.showInfoFromURL_(c,a.coord)},{jsonp:!0})};
M.control.catastroSearchButtonControl.prototype.showInfoFromURL_=function(a,b){if(200===a.code&&!1===a.error){var c=[],d=this.formatInfo_(a.text);c.push(d);var c={icon:"g-cartografia-pin",title:M.control.catastroSearchButtonControl.POPUP_TITLE,content:c.join("")},e=this.facadeMap_.getPopup();if(M.utils.isNullOrEmpty(e))e=new M.Popup,e.addTab(c),this.facadeMap_.addPopup(e,b);else if(e.getCoordinate()[0]==b[0]&&e.getCoordinate()[1]==b[1]){var f=!1;e.getTabs().forEach(function(a){a.title!==M.control.catastroSearchButtonControl.POPUP_TITLE?
f=!0:e.removeTab(a)});f?e.addTab(c):(e=new M.Popup,e.addTab(c),this.facadeMap_.addPopup(e,b))}else e=new M.Popup,e.addTab(c),this.facadeMap_.addPopup(e,b)}else this.facadeMap_.removePopup(),M.dialog.error("MAPEA: No es posible establecer la conexi\u00f3n con el servidor de Catastro")};
M.control.catastroSearchButtonControl.prototype.formatInfo_=function(a){var b;a=(new DOMParser).parseFromString(a,"text/xml").getElementsByTagName("consulta_coordenadas")[0];if("1"==a.getElementsByTagName("control")[0].getElementsByTagName("cuerr")[0].childNodes[0].nodeValue)a=a.getElementsByTagName("lerr")[0].getElementsByTagName("err")[0].getElementsByTagName("des")[0].childNodes[0].nodeValue;else{b=a.getElementsByTagName("coordenadas")[0].getElementsByTagName("coord")[0];a=b.getElementsByTagName("pc")[0].getElementsByTagName("pc1")[0].childNodes[0].nodeValue;
var c=b.getElementsByTagName("pc2")[0].childNodes[0].nodeValue,d=a.substring(0,2),e=a.substring(2,5);b=b.getElementsByTagName("ldt")[0].childNodes[0].nodeValue;a+=c}d="https://www1.sedecatastro.gob.es/CYCBienInmueble/OVCConCiud.aspx?del="+d+"&mun="+e+"&UrbRus=&RefC="+a+"&Apenom=&esBice=&RCBice1=&RCBice2=&DenoBice=";e=M.utils.beautifyAttribute("Informaci\u00f3n Catastral");e+='<div class="divinfo"><table class="mapea-table"><tbody><tr><td class="header" colspan="4"></td></tr>';e+='<tr><td class="key"><b>';
e+=M.utils.beautifyAttribute("Referencia catastral");e+='</b></td><td class="value"></b>';e+="<a href='"+d+"' target='_blank'>"+a+"</a>";e+="</td></tr>";e+='<tr><td class="key"><b>';e+=M.utils.beautifyAttribute("Descripci\u00f3n");e+='</b></td><td class="value">';e+=b;e+="</td></tr>";return e+="</tbody></table></div>"};
M.control.catastroSearchButtonControl.prototype.deactivate=function(){this.facadeMap_.removePopup();this.facadeMap_.un(M.evt.CLICK,this.buildUrl_,this);this.activated=!1;goog.dom.classlist.remove(this.element_.getElementsByTagName("button")["m-catastrogetinfo-button"],"activated")};
M.control.catastroSearchButtonControl.prototype.togglePanel=function(){var a=this.element_.querySelector(".m-tabs-catastrosearch-container");!1===this.panelMinimized?(this.panelMinimized=!0,a.style.display="none",goog.dom.classlist.remove(this.element_.getElementsByTagName("button")["m-catastrosearch-button"],"activated")):(this.panelMinimized=!1,a.style.display="inline",goog.dom.classlist.add(this.element_.getElementsByTagName("button")["m-catastrosearch-button"],"activated"))};
M.control.catastroSearchButtonControl.prototype.onRCSearch=function(a){a.preventDefault();if(a.type!==goog.events.EventType.KEYUP||13===a.keyCode)a=this.inputRC_.value,M.utils.isNullOrEmpty(a)?M.dialog.info("Debe introducir una referencia catastral"):(a=a.substr(0,14),a=M.utils.addParameters(this.CPMRC_url_,{Provincia:"",Municipio:"",SRS:this.facadeMap_.getProjection().code,RC:a}),this.search_(a,this.resultsRCContainer_,this.searchingRCResult_,this.showResults_))};
M.control.catastroSearchButtonControl.prototype.onParamsSearch=function(a){a.preventDefault();if(a.type!==goog.events.EventType.KEYUP||13===a.keyCode)M.utils.isNullOrEmpty(this.selectProvincias.value)||"0"===this.selectProvincias.value?M.dialog.info("Debe seleccionar una provincia"):M.utils.isNullOrEmpty(this.selectMunicipios.value)||"0"===this.selectMunicipios.value?M.dialog.info("Debe seleccionar un municpio"):M.utils.isNullOrEmpty(this.inputPoligono.value)?M.dialog.info("Debe introducir un pol\u00edgono"):
M.utils.isNullOrEmpty(this.inputParcela.value)?M.dialog.info("Debe introducir una parcela"):(a=M.utils.addParameters(this.DNPPP_url_,{CodigoProvincia:this.selectProvincias.value,CodigoMunicipio:this.selectMunicipios.value,CodigoMunicipioINE:"",Poligono:this.inputPoligono.value,Parcela:this.inputParcela.value}),this.search_(a,this.resultsParamsContainer_,this.searchingParamsResult_,this.showResults_))};
M.control.catastroSearchButtonControl.prototype.search_=function(a,b,c,d){goog.dom.appendChild(b,c);goog.dom.classlist.add(this.element_,M.control.catastroSearchButtonControl.SEARCHING_CLASS);var e=this;M.remote.get(a).then(function(a){e.acceptOVCSW(a)&&d.call(e,a.xml,b);goog.dom.classlist.remove(e.element_,M.control.catastroSearchButtonControl.SEARCHING_CLASS)})};
M.control.catastroSearchButtonControl.prototype.acceptOVCSW=function(a){var b=!0;try{if(200===a.code&&!1===a.error){var c=a.xml.childNodes[0],d=c.getElementsByTagName("control")[0].getElementsByTagName("cuerr")[0];a="0";void 0!==d&&(a=d.childNodes[0].nodeValue);if("1"==a){var e=c.getElementsByTagName("lerr")[0].getElementsByTagName("err")[0].getElementsByTagName("des")[0].childNodes[0].nodeValue;goog.dom.classlist.remove(this.element_,M.control.catastroSearchButtonControl.SEARCHING_CLASS);b=!1;M.dialog.info(e)}}else b=
!1,M.dialog.error("MAPEA: No es posible establecer la conexi\u00f3n con el servidor de Catastro")}catch(f){b=!1,M.exception("La respuesta no es un JSON v\u00e1lido: "+f)}return b};
M.control.catastroSearchButtonControl.prototype.parseCPMRCResults=function(a){var b=a.getElementsByTagName("consulta_coordenadas")[0].getElementsByTagName("coordenadas")[0].getElementsByTagName("coord")[0],c=b.getElementsByTagName("pc")[0];a=c.getElementsByTagName("pc1")[0].childNodes[0].nodeValue;var c=c.getElementsByTagName("pc2")[0].childNodes[0].nodeValue,d=b.getElementsByTagName("geo")[0],e=d.getElementsByTagName("xcen")[0].childNodes[0].nodeValue,f=d.getElementsByTagName("ycen")[0].childNodes[0].nodeValue,
d=d.getElementsByTagName("srs")[0].childNodes[0].nodeValue,b=b.getElementsByTagName("ldt")[0].childNodes[0].nodeValue;return{attributes:[{key:"Referencia Catastral",value:a+c},{key:"Descripci\u00f3n",value:b}],rcId:"rc_"+a+c,coords:[{xcen:e,ycen:f,srs:d}]}};
M.control.catastroSearchButtonControl.prototype.showResults_=function(a,b){this.getLayer().clear();var c=this,d={};b===this.resultsRCContainer_?d=this.parseRCResultsForTemplate_(a,!1):b===this.resultsParamsContainer_&&(d=this.parseParamsResultsForTemplate_(a,!1));Promise.resolve(d).then(function(a){c.drawResults(a);M.template.compile(M.control.catastroSearchButtonControl.RESULTS_TEMPLATE,{vars:a}).then(function(a){goog.dom.classlist.remove(b,M.control.catastroSearchButtonControl.HIDDEN_RESULTS_CLASS);
for(var d=b.querySelectorAll(".result"),e,k=0,l=d.length;k<l;k++)e=d.item(k),goog.events.unlisten(e,goog.events.EventType.CLICK,c.resultClick_,!1,c);c.zoomToResults();d=b.querySelector("div.page > div.g-cartografia-flecha-arriba");M.utils.isNullOrEmpty(d)||goog.events.unlisten(d,goog.events.EventType.CLICK,c.resultsClick_,!1,c);b.innerHTML=a.innerHTML;c.resultsScrollContainer_=b.querySelector("div#m-catastro-results-scroll");c.resultsScrollContainer_.scrollIntoView(!1);d=b.getElementsByClassName("result");
a=0;for(l=d.length;a<l;a++)e=d.item(a),goog.events.listen(e,goog.events.EventType.CLICK,c.resultClick_,!1,c);c.fire(M.evt.COMPLETED)})})};M.control.catastroSearchButtonControl.prototype.parseRCResultsForTemplate_=function(a,b){var c=this.parseCPMRCResults(a);!0===b?this.rcResults_.unshift(c):this.rcResults_=[c];return{docs:this.rcResults_,total:this.rcResults_.length,partial:!1,notResutls:!1,query:this.inputRC_.value}};
M.control.catastroSearchButtonControl.prototype.parseParamsResultsForTemplate_=function(a,b){var c=this,d=a.getElementsByTagName("consulta_dnp")[0],e="N/A",f="UR",g=d.getElementsByTagName("lrcdnp");if(0<g.length)var g=g[0].getElementsByTagName("rcdnp")[0],d=g.getElementsByTagName("rc")[0],h=g.getElementsByTagName("dt")[0],g=h.getElementsByTagName("np")[0].childNodes[0].nodeValue,k=h.getElementsByTagName("nm")[0].childNodes[0].nodeValue,l=h.getElementsByTagName("locs")[0].getElementsByTagName("lors")[0].getElementsByTagName("lorus")[0],
h=l.getElementsByTagName("npa")[0].childNodes[0].nodeValue,l=l.getElementsByTagName("cpaj")[0].childNodes[0].nodeValue,e=h+" "+l+". "+k+" ("+g+")";else g=d.getElementsByTagName("bico")[0].getElementsByTagName("bi")[0],d=g.getElementsByTagName("idbi")[0],f=d.getElementsByTagName("cn")[0].childNodes[0].nodeValue,d=d.getElementsByTagName("rc")[0],e=g.getElementsByTagName("ldt")[0].childNodes[0].nodeValue;var p=d.getElementsByTagName("pc1")[0].childNodes[0].nodeValue,m=d.getElementsByTagName("pc2")[0].childNodes[0].nodeValue,
n=this.selectProvincias.value+this.selectMunicipios.value+this.inputPoligono.value+this.inputParcela.value,d=M.utils.addParameters(this.CPMRC_url_,{Provincia:"",Municipio:"",SRS:this.facadeMap_.getProjection().code,RC:p+m});return M.remote.get(d).then(function(a){if(c.acceptOVCSW(a))return a=c.parseCPMRCResults(a.xml),a={attributes:[{key:"Referencia Catastral",value:p+m},{key:"Descripci\u00f3n",value:e},{key:"Tipo",value:f}],paramsId:n,rcId:"rc_"+p+m,coords:[{xcen:a.coords[0].xcen,ycen:a.coords[0].ycen,
srs:a.coords[0].srs}]},!0===b?c.paramsResults_.unshift(a):c.paramsResults_=[a],{docs:c.paramsResults_,total:c.paramsResults_.length,partial:!1,notResutls:!1,query:p+m}})};M.control.catastroSearchButtonControl.prototype.resultClick_=function(a){a.preventDefault();this.facadeMap_.removePopup();this.resultClick(a.currentTarget.id)};
M.control.catastroSearchButtonControl.prototype.clearClick_=function(){goog.dom.classlist.remove(this.element_,"shown");M.utils.isNullOrEmpty(this.inputRC_)||(this.inputRC_.value="");M.utils.isNullOrEmpty(this.selectProvincias)||(this.selectProvincias.value="0");M.utils.isNullOrEmpty(this.selectMunicipios)||(this.selectMunicipios.value="0");M.utils.isNullOrEmpty(this.inputPoligono)||(this.inputPoligono.value="");M.utils.isNullOrEmpty(this.inputParcela)||(this.inputParcela.value="");M.utils.isNullOrEmpty(this.resultsRCContainer_)||
(this.resultsRCContainer_.innerHTML="");M.utils.isNullOrEmpty(this.resultsParamsContainer_)||(this.resultsParamsContainer_.innerHTML="");M.utils.isNullOrEmpty(this.resultsScrollContainer_)||(this.resultsScrollContainer_.innerHTML="",this.resultsScrollContainer_=null);M.utils.isNullOrEmpty(this.rcResults_)?this.rcResults_=[]:this.rcResults_.length=0;M.utils.isNullOrEmpty(this.paramsResults_)?this.paramsResults_=[]:this.paramsResults_.length=0;goog.dom.classlist.remove(this.resultsRCContainer_,M.control.catastroSearchButtonControl.HIDDEN_RESULTS_CLASS);
goog.dom.classlist.remove(this.resultsParamsContainer_,M.control.catastroSearchButtonControl.HIDDEN_RESULTS_CLASS);this.clear()};
M.control.catastroSearchButtonControl.prototype.resultsClick_=function(a){goog.dom.classlist.add(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra-search");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-arriba");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-abajo");goog.dom.classlist.toggle(this.resultsRCContainer_,M.control.catastroSearchButtonControl.HIDDEN_RESULTS_CLASS);goog.dom.classlist.toggle(this.resultsParamsContainer_,M.control.catastroSearchButtonControl.HIDDEN_RESULTS_CLASS)};
M.control.catastroSearchButtonControl.prototype.onProvinciaSelect=function(a){var b=this;a=a.target.value;"0"!==a?M.remote.get(this.ConsultaMunicipioCodigos_,{CodigoProvincia:a,CodigoMunicipio:"",CodigoMunicipioIne:""}).then(function(a){b.loadMunicipiosSelect(a)}):this.clearMunicipiosSelect()};
M.control.catastroSearchButtonControl.prototype.clearMunicipiosSelect=function(){for(var a=this.element_.getElementsByTagName("select")["m-searchParamsMunicipio-select"];a.firstChild;)a.removeChild(a.firstChild);var b=goog.dom.createElement("option");b.value="0";b.innerHTML="Seleccione un municipio";a.appendChild(b)};
M.control.catastroSearchButtonControl.prototype.loadMunicipiosSelect=function(a){if(200===a.code&&!1===a.error){a=a.xml.getElementsByTagName("consulta_municipiero")[0].getElementsByTagName("municipiero")[0].getElementsByTagName("muni");var b=this.element_.getElementsByTagName("select")["m-searchParamsMunicipio-select"];this.clearMunicipiosSelect();for(var c=0;c<a.length;c++){var d=goog.dom.createElement("option"),e=a[c].getElementsByTagName("locat")[0];d.value=e.getElementsByTagName("cmc")[0].childNodes[0].nodeValue;
d.innerHTML=a[c].getElementsByTagName("nm")[0].childNodes[0].nodeValue;b.appendChild(d)}}else M.dialog.error("MAPEA: No es posible establecer la conexi\u00f3n con el servidor de Catastro")};M.control.catastroSearchButtonControl.prototype.equals=function(a){var b=!1;a instanceof M.control.catastroSearchButtonControl&&(b=this.name===a.name);return b};M.control.catastroSearchButtonControl.prototype.destroy=function(){this.destroy()};M.control.catastroSearchButtonControl.SEARCHING_CLASS="m-searching";
M.control.catastroSearchButtonControl.HIDDEN_RESULTS_CLASS="hidden";M.control.catastroSearchButtonControl.POPUP_TITLE="Informaci\u00f3n catastral";M.control.catastroSearchButtonControl.RESULTS_TEMPLATE="catastroresults.html";M.control.catastroSearchButtonControl.TEMPLATE="catastro.html";
M.control.catastroSearchButtonControl.prototype.drawResults=function(a){var b=[];M.utils.isNullOrEmpty(b)&&(b=a.docs);a=b.map(function(a){var b=a.coords[0].xcen,e=a.coords[0].ycen,f={};a.attributes.forEach(function(a){f[a.key]=a.value});return new M.Feature(a.rcId,{type:"Feature",geometry:{type:"Point",coordinates:[b,e]},properties:f})},this);this.layer_.addFeatures(a)};
M.control.catastroSearchButtonControl.prototype.zoomToResults=function(){var a=this.layer_.getFeaturesExtent();this.facadeMap_.removePopup();this.facadeMap_.setBbox(a)};M.control.catastroSearchButtonControl.prototype.getLayer=function(){return this.layer_};
M.control.catastroSearchButtonControl.prototype.resultClick=function(a){a=this.layer_.getFeatureById(a);this.selectedFeatures_=[a];var b=a.getGeometry().coordinates;this.unselectResults();this.selectFeatures([a],b,!0);this.facadeMap_.setCenter(b);this.facadeMap_.setZoom(15)};M.control.catastroSearchButtonControl.prototype.clear=function(){this.facadeMap_.removePopup();this.layer_.clear()};
M.control.catastroSearchButtonControl.prototype.selectFeatures=function(a,b,c){this.unselectResults();this.selectedFeatures_=a;a=this.parseFeaturesForTemplate_(a);var d=this;M.template.compile(M.control.catastroSearchButtonControl.POPUP_RESULT,{jsonp:!1,vars:a,parseToHtml:!1}).then(function(a){a={icon:"g-cartografia-pin",title:M.control.catastroSearchButtonControl.POPUP_TITLE,content:a};var f=d.facadeMap_.getPopup();M.utils.isNullOrEmpty(f)?(f=new M.Popup({panMapIfOutOfView:!c,ani:null}),f.addTab(a),
d.facadeMap_.addPopup(f,b)):f.addTab(a);f.on(M.evt.DESTROY,function(){d.unselectResults(!0)},d)})};M.control.catastroSearchButtonControl.prototype.parseFeaturesForTemplate_=function(a){var b={features:[]};a.forEach(function(a){var d=[];a=a.getAttributes();for(var e in a)d.push({key:e,value:a[e]});b.features.push({attributes:d})});return b};M.control.catastroSearchButtonControl.prototype.unselectResults=function(a){0<this.selectedFeatures_.length&&(this.selectedFeatures_.length=0,a||this.facadeMap_.removePopup())};
M.control.catastroSearchButtonControl.prototype.destroy=function(){this.clear();goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.facadeMap_.getMapImpl().removeControl(this);this.layer_=this.facadeMap_=null};M.control.catastroSearchButtonControl.POPUP_RESULT="catastrofeaturepopup.html";P.plugin={};P.plugin.Catastro={};
(function(){M.plugin.Catastro=function(a){M.utils.isNullOrEmpty(a)&&M.exception("No ha especificado ning\u00fan par\u00e1metro");this.config_=a||{};this.map_=null;this.controls_=[];this.catastroLayer_=null;M.Plugin.call(this)};goog.inherits(M.plugin.Catastro,M.Plugin);M.plugin.Catastro.prototype.addTo=function(a){this.map_=a;this.controls_.push(new M.control.catastroSearchButtonControl(this.config_));goog.dom.classlist.add(a._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");
this.panel_=new M.ui.Panel("Catastro",{collapsible:!0,className:"m-catastro",collapsedButtonClass:"g-catastropanel-button-closed",position:M.ui.position.TL,tooltip:"B\u00fasqueda catastral"});this.panel_.on(M.evt.ADDED_TO_MAP,function(a){M.utils.enableTouchScroll(a)});this.panel_.addControls(this.controls_);this.map_.addPanels(this.panel_);this.config_.config.catastroWMS&&(this.catastroLayer_=new M.layer.WMS({url:this.config_.config.catastroWMS.wms_url,name:this.config_.config.catastroWMS.name,legend:"Catastro",
transparent:!0,tiled:!1}),this.map_.addWMS(this.catastroLayer_));var b=this;this.controls_[0].on(M.evt.ADDED_TO_MAP,function(){b.fire(M.evt.ADDED_TO_MAP)})};M.plugin.Catastro.prototype.destroy=function(){this.map_.removeControls(this.controls_);this.controls_=this.map_=null};M.plugin.Catastro.prototype.getControls=function(){return this.controls_};M.plugin.Catastro.prototype.getResultsLayer=function(){return this.controls_[0].getLayer()};M.plugin.Catastro.prototype.getWMSCatastroLayer=function(){return this.catastroLayer_}})();P.impl={};P.impl.control={};P.impl.control.catastroSearchButtonControl={};M.impl.control.catastroSearchButtonControl=function(){this.element_=this.facadeMap=null;M.impl.Control.call(this)};goog.inherits(M.impl.control.catastroSearchButtonControl,M.impl.Control);M.impl.control.catastroSearchButtonControl.prototype.addTo=function(a,b){M.impl.control.catastroSearchButtonControl.superClass_.addTo.call(this,a,b)};P.templates={};P.templates.catastro={};
(function(a){a.template.add("catastro.html",Handlebars.template({compiler:[7,">= 4.0.0"],main:function(a,c,d,e,f){return'<div id="catastrosearch-id" class="m-control m-catastrosearch-container">\n\t<div class="header">\n\t\t\x3c!-- TITLE --\x3e\n\t\t\x3c!--<div class="titleBusquedaCatastral">B\u00fasqueda catastral</div>--\x3e\n\t\t<button id="m-catastrosearch-button" class="icon-navigation-busqueda-catastral" title="B\u00fasqueda catastral"></button>\n\t\t<button id="m-catastrogetinfo-button" class="g-cartografia-catastrogetinfo-button" title="Consultar datos catastrales"></button>\n\t\t<button id="m-catastroclear-button" class="g-cartografia-papelera" title="Limpiar resultados"></button>\n\t</div>\n\t<div class="m-tabs-catastrosearch-container">\n\t\t<ul id="m-tabs-catastrosearch" class="group">\n\t\t\t<li><a href="#" class="activated">Referencia Catastral</a></li>\n\t\t\t<li><a href="#">Par\u00e1metros</a></li>\n\t\t</ul>\n\t\t<div id="m-tabs-catastrosearch-content">\n\t\t\t\x3c!-- Par\u00e1metros de b\u00fasqueda --\x3e\n\t\t\t<div id="m-searchRC-container" class="m-searchRC-tab m-tabcontent-catastrosearch show">\n\t\t\t\t<input type="text" id="m-searchRC-input" class="g-cartografia-searchRC-input" maxlength="20" placeholder="Introduzca los 14 \u00f3 20 d\u00edgitos de la RC"></input>\n\t\t\t\t<div id="button-rc" class="button">\n\t\t\t\t\t<button id="m-searchRC-button" class="search" title="Buscar">\n\t\t\t\t\t\t<i class="g-cartografia-zoom m-search-btn"></i>Buscar\n\t\t\t\t\t</button>\n\t\t\t\t\t<button id="m-clearRC-button" class="search" title="Limpiar Resultados">\n\t\t\t\t\t\t<i class="g-cartografia-papelera m-search-btn"></i>Limpiar\n\t\t\t\t\t</button>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div id="m-searchParams-container" class="m-searchParams-tab m-tabcontent-catastrosearch">\n\t\t\t\t<label id="m-searchParamsProvincia-label" class="g-cartografia-searchParamsProvincia-label">Provincia:</label>\n\t\t\t\t<select id="m-searchParamsProvincia-select" name="Provincias" class="g-cartografia-searchParamsProvincia-select">\n\t\t\t\t\t<option value="0">Seleccione una provincia</option>\n\t\t\t\t\t<option value="04">ALMER\u00cdA</option>\n\t\t\t\t\t<option value="11">C\u00c1DIZ</option>\n\t\t\t\t\t<option value="14">C\u00d3RDOBA</option>\n\t\t\t\t\t<option value="18">GRANADA</option>\n\t\t\t\t\t<option value="21">HUELVA</option>\n\t\t\t\t\t<option value="23">JA\u00c9N</option>\n\t\t\t\t\t<option value="29">M\u00c1LAGA</option>\n\t\t\t\t\t<option value="41">SEVILLA</option>\n\t\t\t\t</select>\n\t\t\t\t<br>\n\t\t\t\t<label id="m-searchParamsMunicipio-label" class="g-cartografia-searchParamsMunicipio-label">Municipio:</label>\n\t\t\t\t<select id="m-searchParamsMunicipio-select" name="Municipios" class="g-cartografia-searchParamsMunicipio-select">\n\t\t\t\t\t<option value="0">Seleccione un municipio</option>\n\t\t\t\t</select>\n\t\t\t\t<br>\n\t\t\t\t<label id="m-searchParamsPoligono-label" class="g-cartografia-searchParamsPoligono-label">Pol\u00edgono:</label>\n\t\t\t\t<input type="text" id="m-searchParamsPoligono-input" class="g-cartografia-searchParamsPoligono-input" placeholder="Introduzca un pol\u00edgono">\n\t\t\t\t<br>\n\t\t\t\t<label id="m-searchParamsParcela-label" class="g-cartografia-searchParamsParcela-label">Parcela:</label> <input type="text"\n\t\t\t\t    id="m-searchParamsParcela-input" class="g-cartografia-searchParamsParcela-input" placeholder="Introduzca una parcela">\n\t\t\t\t<div id="button-params" class="button">\n\t\t\t\t\t<button id="m-searchParams-button" class="search" title="Buscar">\n\t\t\t\t\t\t<i class="g-cartografia-zoom m-search-btn"></i>Buscar\n\t\t\t\t\t</button>\n\n\t\t\t\t\t<button id="m-clearParams-button" class="search" title="Limpiar Resultados">\n\t\t\t\t\t\t<i class="g-cartografia-papelera m-search-btn"></i>Limpiar\n\t\t\t\t\t</button>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t\x3c!-- Resultados de b\u00fasqueda --\x3e\n\t\t<div id=m-catastrosearch-results>\n\t\t\t\x3c!-- results searchRC --\x3e\n\t\t\t<div id="m-searchRC-results" class="m-searchRC m-tabcontent-catastrosearch results-panel show">\n\t\t\t\t<div id="m-searching-result-searchRC" class="m-searching-result g-cartografia-spinner"></div>\n\t\t\t</div>\n\t\t\t\x3c!-- results searchParams --\x3e\n\t\t\t<div id="m-searchParams-results" class="m-searchParams m-tabcontent-catastrosearch results-panel">\n\t\t\t\t<div id="m-searching-result-searchParams" class="m-searching-result g-cartografia-spinner"></div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>'},useData:!0}));
a.template.add("catastrofeaturepopup.html",Handlebars.template({1:function(a,c,d,e,f){var g;return'   <div class="result">\n'+(null!=(g=d.each.call(null!=c?c:a.nullContext||{},null!=c?c.attributes:c,{name:"each",hash:{},fn:a.program(2,f,0),inverse:a.noop,data:f}))?g:"")+'   </div>\n   <div class="m-separator"></div>\n'},2:function(a,c,d,e,f){var g,h;e=null!=c?c:a.nullContext||{};var k=d.helperMissing;return'      <table>\n         <tr>\n            <td class="key"><b>'+a.escapeExpression((h=null!=
(h=d.key||(null!=c?c.key:c))?h:k,"function"===typeof h?h.call(e,{name:"key",hash:{},data:f}):h))+'</b></td>\n            <td class="value'+(null!=(g=(d.oneword||c&&c.oneword||k).call(e,null!=c?c.value:c,{name:"oneword",hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f}))?g:"")+'">'+(null!=(g=(h=null!=(h=d.value||(null!=c?c.value:c))?h:k,"function"===typeof h?h.call(e,{name:"value",hash:{},data:f}):h))?g:"")+"</td>\n         </tr>\n      </table>\n"},3:function(a,c,d,e,f){return" m-wordbreak"},compiler:[7,
">= 4.0.0"],main:function(a,c,d,e,f){var g;return'<div class="m-catastrogetinfo-content">\n'+(null!=(g=d.each.call(null!=c?c:a.nullContext||{},null!=c?c.features:c,{name:"each",hash:{},fn:a.program(1,f,0),inverse:a.noop,data:f}))?g:"")+"</div>"},useData:!0}));a.template.add("catastroresults.html",Handlebars.template({1:function(a,c,d,e,f){return'   <div class="partial">\n      <p>No se han encontrado resultados para la b\u00fasqueda.</p>\n   </div>\n'},3:function(a,c,d,e,f){var g,h;e=null!=c?c:a.nullContext||
{};return'      <div id="'+a.escapeExpression((h=null!=(h=d.rcId||(null!=c?c.rcId:c))?h:d.helperMissing,"function"===typeof h?h.call(e,{name:"rcId",hash:{},data:f}):h))+'" class="result">\n'+(null!=(g=d.each.call(e,null!=c?c.attributes:c,{name:"each",hash:{},fn:a.program(4,f,0),inverse:a.noop,data:f}))?g:"")+"      </div>\n"},4:function(a,c,d,e,f){var g,h;e=null!=c?c:a.nullContext||{};var k=d.helperMissing;return'         <table>\n            <tbody>\n               <tr>\n                  <td class="key">'+
a.escapeExpression((h=null!=(h=d.key||(null!=c?c.key:c))?h:k,"function"===typeof h?h.call(e,{name:"key",hash:{},data:f}):h))+'</td>\n                  <td class="value'+(null!=(g=(d.oneword||c&&c.oneword||k).call(e,null!=c?c.value:c,{name:"oneword",hash:{},fn:a.program(5,f,0),inverse:a.noop,data:f}))?g:"")+'">'+(null!=(g=(h=null!=(h=d.value||(null!=c?c.value:c))?h:k,"function"===typeof h?h.call(e,{name:"value",hash:{},data:f}):h))?g:"")+"</td>\n               </tr>\n            </tbody>\n         </table>\n"},
5:function(a,c,d,e,f){return" m-wordbreak"},7:function(a,c,d,e,f){var g;return'   <div class="results">\n      <div class="partial">No se han encontrado resultados para la b\u00fasqueda "'+a.escapeExpression((g=null!=(g=d.query||(null!=c?c.query:c))?g:d.helperMissing,"function"===typeof g?g.call(null!=c?c:a.nullContext||{},{name:"query",hash:{},data:f}):g))+'".</div>\n   </div>\n'},compiler:[7,">= 4.0.0"],main:function(a,c,d,e,f){var g,h;e=null!=c?c:a.nullContext||{};var k=d.helperMissing,l=a.escapeExpression;
return'<div class="catastro-results-panels">\n'+(null!=(g=d["if"].call(e,null!=c?c.partial:c,{name:"if",hash:{},fn:a.program(1,f,0),inverse:a.noop,data:f}))?g:"")+'   <div class="results" id="m-catastro-results-scroll">\n'+(null!=(g=d.each.call(e,null!=c?c.docs:c,{name:"each",hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f}))?g:"")+"   </div>\n"+(null!=(g=(d.eq||c&&c.eq||k).call(e,null!=(g=null!=c?c.docs:c)?g.length:g,0,{name:"eq",hash:{},fn:a.program(7,f,0),inverse:a.noop,data:f}))?g:"")+'   <div class="page">\n      <span class="found" id="m-catastro-page-found">'+
l(a.lambda(null!=(g=null!=c?c.docs:c)?g.length:g,c))+'</span> de <span class="total">'+l((h=null!=(h=d.total||(null!=c?c.total:c))?h:k,"function"===typeof h?h.call(e,{name:"total",hash:{},data:f}):h))+"</span>\n   </div>\n</div>"},useData:!0}))})(window.M);goog.exportSymbol("M.plugin.Catastro",M.plugin.Catastro);goog.exportProperty(M.plugin.Catastro.prototype,"addTo",M.plugin.Catastro.prototype.addTo);goog.exportProperty(M.plugin.Catastro.prototype,"destroy",M.plugin.Catastro.prototype.destroy);goog.exportProperty(M.plugin.Catastro.prototype,"getControls",M.plugin.Catastro.prototype.getControls);goog.exportProperty(M.plugin.Catastro.prototype,"getWMSCatastroLayer",M.plugin.Catastro.prototype.getWMSCatastroLayer);
goog.exportSymbol("M.impl.control.catastroSearchButtonControl",M.impl.control.catastroSearchButtonControl);goog.exportProperty(M.impl.control.catastroSearchButtonControl.prototype,"addTo",M.impl.control.catastroSearchButtonControl.prototype.addTo);goog.exportSymbol("M.control.catastroSearchButtonControl",M.control.catastroSearchButtonControl);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"createView",M.control.catastroSearchButtonControl.prototype.createView);
goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"addEvents",M.control.catastroSearchButtonControl.prototype.addEvents);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"createCatastroPanel",M.control.catastroSearchButtonControl.prototype.createCatastroPanel);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"setStyle",M.control.catastroSearchButtonControl.prototype.setStyle);
goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"activeSearch",M.control.catastroSearchButtonControl.prototype.activeSearch);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"activeInfo",M.control.catastroSearchButtonControl.prototype.activeInfo);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"addClearEvents",M.control.catastroSearchButtonControl.prototype.addClearEvents);
goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"clearResults",M.control.catastroSearchButtonControl.prototype.clearResults);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"equals",M.control.catastroSearchButtonControl.prototype.equals);goog.exportSymbol("M.control.catastroSearchButtonControl.NAME",M.control.catastroSearchButtonControl.NAME);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"activate",M.control.catastroSearchButtonControl.prototype.activate);
goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"deactivate",M.control.catastroSearchButtonControl.prototype.deactivate);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"togglePanel",M.control.catastroSearchButtonControl.prototype.togglePanel);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"onRCSearch",M.control.catastroSearchButtonControl.prototype.onRCSearch);
goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"onParamsSearch",M.control.catastroSearchButtonControl.prototype.onParamsSearch);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"onProvinciaSelect",M.control.catastroSearchButtonControl.prototype.onProvinciaSelect);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"clearMunicipiosSelect",M.control.catastroSearchButtonControl.prototype.clearMunicipiosSelect);
goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"loadMunicipiosSelect",M.control.catastroSearchButtonControl.prototype.loadMunicipiosSelect);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"equals",M.control.catastroSearchButtonControl.prototype.equals);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"destroy",M.control.catastroSearchButtonControl.prototype.destroy);
goog.exportSymbol("M.control.catastroSearchButtonControl.SEARCHING_CLASS",M.control.catastroSearchButtonControl.SEARCHING_CLASS);goog.exportSymbol("M.control.catastroSearchButtonControl.HIDDEN_RESULTS_CLASS",M.control.catastroSearchButtonControl.HIDDEN_RESULTS_CLASS);goog.exportSymbol("M.control.catastroSearchButtonControl.POPUP_TITLE",M.control.catastroSearchButtonControl.POPUP_TITLE);goog.exportSymbol("M.control.catastroSearchButtonControl.RESULTS_TEMPLATE",M.control.catastroSearchButtonControl.RESULTS_TEMPLATE);
goog.exportSymbol("M.control.catastroSearchButtonControl.TEMPLATE",M.control.catastroSearchButtonControl.TEMPLATE);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"drawResults",M.control.catastroSearchButtonControl.prototype.drawResults);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"zoomToResults",M.control.catastroSearchButtonControl.prototype.zoomToResults);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"getLayer",M.control.catastroSearchButtonControl.prototype.getLayer);
goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"resultClick",M.control.catastroSearchButtonControl.prototype.resultClick);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"clear",M.control.catastroSearchButtonControl.prototype.clear);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"selectFeatures",M.control.catastroSearchButtonControl.prototype.selectFeatures);
goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"unselectResults",M.control.catastroSearchButtonControl.prototype.unselectResults);goog.exportProperty(M.control.catastroSearchButtonControl.prototype,"destroy",M.control.catastroSearchButtonControl.prototype.destroy);goog.exportSymbol("M.control.catastroSearchButtonControl.POPUP_RESULT",M.control.catastroSearchButtonControl.POPUP_RESULT); })(window.M);
